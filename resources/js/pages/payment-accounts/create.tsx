...
interface PaymentAccountCreateProps extends PageProps { }

export default function Create({ auth }: PaymentAccountCreateProps) {
  const { data, setData, post, processing, errors, reset } = useForm({
    handle: '',
    type: 'venmo' as 'venmo' | 'zelle' | 'paypal' | 'cash_app',
    name: '',
    description: '',
            ...
            <form onSubmit={submit} className="p-6 space-y-6">
              ...
              <div className="flex items-center justify-end space-x-4">
                ...
                <PrimaryButton disabled={processing}>
                  {processing ? 'Creating...' : 'Create Payment Account'}
                </PrimaryButton>
              </div>
            </form>
          </div>
